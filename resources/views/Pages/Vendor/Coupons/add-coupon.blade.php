...
@section('title', 'Manage Coupon | Vendor | Gudpanda')
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="mb-3">
                                ...
                                <input type="number" id="coupons-limits" name="coupons-limits" class="form-control"
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="">
                                ...
                                <input type="text" id="discount-value" name="discount-value" class="form-control"
