...
@section('title', 'Orders | Vendor | Gudpanda')
                            ...
                            <table class="table align-middle mb-0 table-hover table-centered">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>Apr 23 , 2024</td>
                                        <td>
                                            <a href="#!" class="link-primary fw-medium">Gail
                                                C. Anderson</a>
                                        </td>
                                        <td> Normal</td>
                                        <td> $1,230.00</td>
                                    ...
                                    <tr>
                                        ...
                                        <td>Apr 20 , 2024</td>
                                        <td>
                                            <a href="#!" class="link-primary fw-medium">Jung
                                                S. Ayala</a>
                                        </td>
                                        <td> Normal</td>
                                        <td> $987.00</td>
                                    ...
                                    <tr>
                                        ...
                                        <td>Apr 19 , 2024</td>
                                        <td>
                                            <a href="#!" class="link-primary fw-medium">David
                                                A. Arnold</a>
                                        </td>
                                        <td> High</td>
                                        <td> $1,478.00</td>
                                    ...
                                    <tr>
                                        ...
                                        <td>Apr 04 , 2024</td>
                                        <td>
                                            <a href="#!" class="link-primary fw-medium">Cecile
                                                D. Gordon</a>
                                        </td>
                                        <td> Normal</td>
                                        <td> $720.00</td>
                                        <td> <span class="badge bg-light text-dark  px-2 py-1 fs-13">Refund</span>
                                        </td>
                                        <td> 4</td>
                                        <td> -</td>
                                        <td> <span
                                    ...
                                    <tr>
                                        ...
                                        <td>Apr 02 , 2024</td>
                                        <td>
                                            <a href="#!" class="link-primary fw-medium">William
                                                Moreno</a>
                                        </td>
                                        <td> Normal</td>
                                        <td> $1,909.00</td>
                                    ...
                                    <tr>
                                        ...
                                        <td>March 28 , 2024</td>
                                        <td>
                                            <a href="#!" class="link-primary fw-medium">Alphonse
                                                Roy</a>
                                        </td>
                                        <td> High</td>
                                        <td> $879.00</td>
                                    ...
                                    <tr>
                                        ...
                                        <td>March 20 , 2024</td>
                                        <td>
                                            <a href="#!" class="link-primary fw-medium">Pierpont
                                                Marleau</a>
                                        </td>
                                        <td> High</td>
                                        <td> $1,230.00</td>
                                    ...
                                    <tr>
                                        ...
                                        <td>March 12 , 2024</td>
                                        <td>
                                            <a href="#!" class="link-primary fw-medium">Madeleine
                                                Gervais</a>
                                        </td>
                                        <td> Normal</td>
                                        <td> $1,264.00</td>
                                    ...
                                    <tr>
                                        ...
                                        <td>March 02 , 2024</td>
                                        <td>
                                            <a href="#!" class="link-primary fw-medium">Satordi
                                                Gaillou</a>
                                        </td>
                                        <td> High</td>
                                        <td> $1,787.00</td>
